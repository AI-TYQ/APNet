...
from APNet.util import format_time
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        if os.path.isfile(args.pretrained):
            ...
            if not 'linear_model_best' in args.pretrained:
                ...
                for k in checkpoint['state_dict']:
                    state_dict[k[len('module.'):]] = checkpoint['state_dict'][k]
...
def sanity_check(args, state_dict, pretrained_weights):
    ...
    """
    if 'linear_model_best' in args.pretrained:
        return True
    progress = ProgressMeter(args)
